                ...
                <tbody>
                  {group.cuotas.map((row) => (
                    <tr key={row.cuotaId} className={row.diasAtraso > 0 ? "bg-rose-50/40" : ""}>
                      ...
                      <td className="table-cell"><div className="flex flex-wrap gap-1"><Link href={`/cuotas/${row.contratoId}`} className="rounded border border-[var(--border)] px-2 py-1 text-xs">Ver cuota</Link><button disabled type="button" className="rounded border border-[var(--border)] px-2 py-1 text-xs">Pago PagaCuotas</button><button disabled type="button" className="rounded border border-[var(--border)] px-2 py-1 text-xs">Registrar gestion</button><Link href="/reportes/historial" className="rounded border border-[var(--border)] px-2 py-1 text-xs">Ir historial</Link></div></td>
                    </tr>
                  ))}
                </tbody>
              </table>
