...
export function TimerLauncher({ caseId, caseCode }: TimerLauncherProps) {
  ...
  async function start() {
    ...
    try {
      ...
      // Notificar al widget flotante para que aparezca de inmediato sin
      // esperar al poll de 30s. `router.refresh()` además queda como
      // garantía para re-render de stats server-side.
