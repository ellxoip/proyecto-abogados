...
const formatProviderName = (name: string) => providerDisplayNames[name] ?? name;
              ...
              return (
                <div key={provider.name} className="rounded-lg border border-border-subtle p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <h3 className="text-sm font-black uppercase text-primary">{formatProviderName(provider.name)}</h3>
